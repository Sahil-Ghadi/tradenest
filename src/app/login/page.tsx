  ...
  return (
    <div className="z-0">
      <div className="h-[616px] flex flex-col justify-center items-center">
        <div className="h-[400px] w-[380px] rounded-xl border-4 bg-white dark:bg-gray-800 outline-4 outline outline-teal-200 dark:outline-gray-700 border-blue-600 dark:border-gray-600 border-solid flex flex-col mb-8 sm:w-[410px]">
          <div>
