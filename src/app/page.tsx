...
export default function Home() {
  ...
  return (
    <main className="container mx-auto sm:pl-9 bg-white h-screen">
      <h1 className="mb-5 pt-5 sm:ml-4 text-4xl text-black sm:text-start text-center font-bold">Featured Products</h1>
